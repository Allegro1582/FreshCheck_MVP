...
@if "%DEBUG%" == "" @echo off
@rem %~dp0 is the directory where this script resides.
set APP_HOME=%~dp0
...
for %%i in ("%JAVA_EXE%") do if exist "%%~fi" set JAVA_EXE="%%~fi"
...
:init
@rem Get command-line arguments, handling Windows command-line parsing peculiarities.
set CMD_LINE_ARGS=
set _SKIP=2
